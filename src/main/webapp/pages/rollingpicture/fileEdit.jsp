				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="adForm" action="/Express/rollingpicture/update.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								<input name="id" type="hidden" value="${pic.id}">
								<input name="filesrc" type="hidden" value="${pic.filesrc}">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6 m-wrap" name="title" value="${pic.title}" />
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6 m-wrap" name="link" value="${pic.link}"/>
										<span class="help-inline">必填</span>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="width: 250px; height: 150px;">
												<img src="/epUpload${pic.filesrc}" alt="" style="width: 250px; height: 150px;" />
											</div>
