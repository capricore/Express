					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>员工黑名单列表</div>
							</div>
								...
								<tbody>
									<c:forEach  items="${blacklists}"  var="item"  varStatus="status">
										<tr class="">
											...
											<td>${item.name}</td>
											<td>${item.compname}</td>											
											<td><a  href="/Express/userblacklist/edit.do?userid=${item.userid}">Edit</a></td>
	...
	<script>
		jQuery(document).ready(function() {       
	  	...
	  	function deleteUser(id){
            ...
            var url="/Express/userblacklist/delUser.do";
