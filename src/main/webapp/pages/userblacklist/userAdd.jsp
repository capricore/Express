				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="companyForm" action="/Express/userblacklist/save.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								<div class="control-group">
									<label class="control-label">员工姓名</label>
									<div class="controls">
										<input id="name" type="text" class="span6 m-wrap" name="name"/>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="compname" type="text" class="span6 m-wrap" name="compname"/>
										<span class="help-inline">必填</span>
									</div>
								</div>	
							</form>
