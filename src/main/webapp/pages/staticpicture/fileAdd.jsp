					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>添加滚动图片</div>
							</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="adForm" action="/Express/staticpicture/save.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6 m-wrap" name="description" />
