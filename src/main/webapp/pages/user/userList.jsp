					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>会员列表</div>
							</div>
								...
								<tbody>
									<c:forEach  items="${userList}"  var="item"  varStatus="status">
										<tr class="">
											...
											<td>${item.username}</td>
											<td><a  href="/Express/user/userView.do?userid=${item.userid}">View</a></td>
											<td><a  href="/Express/user/userEdit.do?userid=${item.userid}">Edit</a></td>
											<td><a  href="javascript:deleteUser('${item.userid}')">Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
	...
	<script>
		jQuery(document).ready(function() {       
	  	...
	  	function deleteUser(id){
            ...
            var url="/Express/user/delUser.do";
