				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="userForm" action="/Express/user/update.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="password" type="text" class="span6 m-wrap" name="password" value="${user.passwd}" />
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="company" class="span6 m-wrap" data-placeholder="选择公司类别" tabindex="1" name="company">
