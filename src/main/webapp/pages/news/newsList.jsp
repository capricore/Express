					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>${subtype}</div>
							</div>
								...
								<tbody>
									<c:forEach  items="${newsList}"  var="item"  varStatus="status">
										<tr class="">
											...
											<td>${item.title}</td>
											<td>${item.crtime}</td>
											<td><a  href="/Express/news/view.do?newsid=${item.newsid}">View</a></td>
											<td><a  href="javascript:deleteRs('${item.newsid}')">Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
