					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>公司列表</div>
							</div>
								...
								<tbody>
									<c:forEach  items="${companyList}"  var="item"  varStatus="status">
										<tr class="">
											...
											<td>${item.compname}</td>
											<td><a  href="/Express/company/companyView.do?compid=${item.compid}">View</a></td>
											<td><a  href="/Express/company/companyEdit.do?compid=${item.compid}">Edit</a></td>
											<td><a  href="javascript:deleteUser('${item.compid}')">Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
	...
	<script>
		jQuery(document).ready(function() {       
	  	...
	  	function deleteUser(id){
            ...
            var url="/Express/company/delComp.do";
            $.post(url,{compid:id},function(data){
            	postDelUser(data);
            });
        }
