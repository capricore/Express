						...
						<div class="portlet-body form">
							<form id="hpForm" action="#" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="address" type="text"  readonly="true" class="span6 m-wrap" name="address" value="${company.address} "/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">所属主公司名称</label>
									<div class="controls">
										<input id="pcompname" type="text" readonly="true" class="span6 m-wrap" name="pcompname" value="${pcompname}"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">公司电话</label>
									<div class="controls">
										<input id="tel" type="text" readonly="true" class="span6 m-wrap" name="tel" value="${company.tel}"/>
									</div>
								</div>	
								<div class="control-group">
