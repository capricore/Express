					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>添加电商</div>
							</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="companyForm" action="/Express/mercblacklist/save.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								<div class="control-group">
									<label class="control-label">公司名称</label>
									<div class="controls">
										<input id="mercname" type="text" class="span6 m-wrap" name="mercname"/>
