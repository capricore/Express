					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>${user.mercname}</div>
							</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="userForm" action="/Express/mercblacklist/update.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								<input name="mercid" type="hidden" value="${user.mercid }">
								<div class="control-group">
									<label class="control-label">电商名称</label>
									<div class="controls">
										<input id="mercname" type="text" class="span6 m-wrap" name="mercname" value="${user.mercname}"/>
