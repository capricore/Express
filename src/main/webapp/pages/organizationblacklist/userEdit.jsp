				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a >${user.organizationname}</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>${user.organizationname}</div>
							</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="userForm" action="/Express/organizationblacklist/update.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								<input name="organizationid" type="hidden" value="${user.organizationid }">
								<div class="control-group">
									<label class="control-label">快递公司名称</label>
									<div class="controls">
										<input id="organizationname" type="text" class="span6 m-wrap" name="organizationname" value="${user.organizationname}"/>
