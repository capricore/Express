					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>快递公司列表</div>
							</div>
								...
								<tbody>
									<c:forEach  items="${blacklists}"  var="item"  varStatus="status">
										<tr class="">
											...
											<td><a  href="/Express/organizationblacklist/edit.do?organizationid=${item.organizationid}">Edit</a></td>
											<td><a  href="javascript:deleteUser('${item.organizationid}')">Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
	...
	<script>
		jQuery(document).ready(function() {       
	  	...
	  	function deleteUser(id){
            ...
            var url="/Express/organizationblacklist/delUser.do";
            $.post(url,{organizationid:id},function(data){
            	postDelUser(data);
            });
        }
